...
public interface ChatAssistant {
    ...
    /**
     * The most basic interaction: sends a single prompt to the LLM and gets a
    ...
    /**
     * Sends a prompt to the LLM and streams the response back as it's being
     * generated.
     * This is useful for providing a more interactive, real-time experience to the
     * user.
     *
     * @param message The user's question or instruction.
     * @return A Stream that emits the response in chunks (tokens) as they are
     ...
     * @return A {@link Stream} of strings. It emits chunks as they are generated,
     *         grounded with the provided context.
     *
     */
    Flux<String> askQuestionWithContext(String conversationId, String question);

    /**
     * Provides a unified way to ask a question, supporting both synchronous (single
     * response)
     * and asynchronous (streaming) modes. This method always returns a Stream.
     *
     * @param message The user's question or instruction.
     * @param stream  If true, streams the response. If false, returns a stream
     *                containing a single, complete response.
     * @return A {@link Stream} of strings. If streaming, it emits chunks as they
     *         are generated.
     *         If not streaming, it emits a single element containing the full
     *         response.
     */
